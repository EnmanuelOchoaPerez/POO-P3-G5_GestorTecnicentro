...
public class ReporteServicios extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (tvEncabezado != null) {
            tvEncabezado.setText("Reportes de Ingresos por Servicio");
        }
    ...
    //Metodo para GenerarReporteIngresoServicio
    public void GenerarRis(View v) {
        ...
        // Segunda línea encabezado (Servicios y Recaudo)
        ...
        serviciosEncabezado.setText("Servicios");
        ...
        recaudoEncabezado.setText("Recaudo");
        ...
        for (Servicio servicio : RepositorioPruebaAvance.getInstance().getServicios()) {
            double gananciaMes = servicio.getGanancia(selectedYM);
            if (gananciaMes > 0) {
                hayResultados = true;
                ...
                // Nombre del servicio
                TextView nombreServicio = new TextView(this);
                nombreServicio.setText(servicio.getNombre());
                nombreServicio.setLayoutParams(new LinearLayout.LayoutParams(0, LinearLayout.LayoutParams.WRAP_CONTENT, 1f));

                // Recaudo
                TextView recaudo = new TextView(this);
                recaudo.setText(String.format(Locale.getDefault(), "$ %.2f", gananciaMes));
